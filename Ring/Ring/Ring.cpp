...
BEGIN_MESSAGE_MAP(CRingApp, CWinAppEx)
...
// CRingApp customization load/save methods

void CRingApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CRingApp::LoadCustomState()
{
}

void CRingApp::SaveCustomState()
{
}
